...
var ClsItems = {
    GetAll: function () {
        Helper.AjaxCallGet("https://localhost:7191/api/Items", {}, "json",
            function (data) {
    ...
    DrawItem: function (item) {
        ...
        data += "<div class='front'> <a href='#'><img src='/Uploads/Items/" + item.imageName.replace(/\s+/g, '') + "' class='img-fluid blur-up lazyload bg-img' alt=''></a></div>";
