...
namespace Bl.Migrations
{
    ...
    [Migration("20240809154113_Pagesmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LapStore.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapStore.Models.TbItem", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapStore.Models.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapStore.Models.TbPages", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapStore.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapStore.Models.TbSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapStore.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("LapStore.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapStore.Models.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapStore.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapStore.Models.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("LapStore.Models.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LapStore.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("LapStore.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("LapStore.Models.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("LapStore.Models.TbItem", b =>
                {
                    b.HasOne("LapStore.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("LapStore.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
                        .HasForeignKey("ItemTypeId")
                        .HasConstraintName("FK_TbItems_TbItemTypes");

                    b.HasOne("LapStore.Models.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
            ...
            modelBuilder.Entity("LapStore.Models.TbItemDiscount", b =>
                {
                    b.HasOne("LapStore.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("LapStore.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("LapStore.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("LapStore.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("LapStore.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("LapStore.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("LapStore.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("LapStore.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LapStore.Models.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
