...
public partial class LapShopContext : IdentityDbContext<ApplicationUser>
{
    ...
    public virtual DbSet<VwUsers> VwUsers { get; set; } = null!;
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=DESHA;Database=LapShop;Trusted_Connection=True;TrustServerCertificate=Yes");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasNoKey(); // Views do not have primary keys
